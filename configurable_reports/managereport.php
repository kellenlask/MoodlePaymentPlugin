...
/** Configurable Reports
  ...
  */
	...
	if($reports){
		$table = new stdclass;
		$table->width = "100%";
		$table->head = array(get_string('transactions'),get_string('name'),get_string('reportsmanage','admin').' '.get_string('course'),get_string('type','block_configurable_reports'),get_string('username'),get_string('edit'),get_string('download','block_configurable_reports'));

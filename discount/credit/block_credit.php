...
class block_credit extends block_base {
    ...
    public function init() {
        $this->title = get_string('pluginname', 'block_credit'); //This should grab the app name from the /lang/en/block_discount.php file
    ...
    public function get_content() {
        ...
        $url - new moodle_url('/blocks/discount/credit/view.php', array('blockid' => $this->instance->id, 'courseid' => $COURSE->id));
        $this -> content -> footer = html_writer::link($url, "credits");
